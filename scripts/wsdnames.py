...
THIS VERSION WORKS ON SWAY WITH NOT-YET-FIXED i3ipc v1.7.1 MODULE
...
def on_window_new(i3, e):
    try:
        ...
        if w_name and ws_num:
            ...
            i3.command('rename workspace number "%s" to %s' % (ws_num, name))
