...
badd +1 flake.nix
badd +5 nixos/common.nix
badd +1 nixos/dev.nix
badd +54 nixos/linux.nix
badd +53 nixos/linux-gui.nix
badd +0 nixos/pkgs/xonsh.nix
argglobal
%argdel
$argadd flake.nix
...
silent! normal! zE
let &fdl = &fdl
let s:l = 40 - ((25 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 40
...
silent! normal! zE
let &fdl = &fdl
let s:l = 53 - ((48 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 53
