...
class TypeScriptServiceClient {
    ...
    getProjectRootPath(uri) {
        ...
        if (u.scheme != 'file')
            return coc_nvim_1.workspace.cwd;
        if (u.fsPath.startsWith(coc_nvim_1.workspace.root) && coc_nvim_1.workspace.root != os_1.default.homedir())
            return coc_nvim_1.workspace.root;
        let res = find_up_1.default.sync(['tsconfig.json', 'jsconfig.json'], { cwd: path_1.default.dirname(u.fsPath) });
        return res ? path_1.default.dirname(res) : coc_nvim_1.workspace.cwd;
    }
