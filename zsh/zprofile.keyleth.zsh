...
PATH="/opt/homebrew/opt/coreutils/libexec/gnubin:/opt/homebrew/opt/python/libexec/bin:/usr/local/MacGPG2/bin:$PATH:/opt/homebrew-rosetta/bin:/opt/homebrew/opt/llvm/bin"
